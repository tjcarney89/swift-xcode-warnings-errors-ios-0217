...
<img src="https://curriculum-content.s3.amazonaws.com/ios/ios-objc-fundamentals-unit/xcode_warning_icon.png" style="width: 200px;">
<img src="https://curriculum-content.s3.amazonaws.com/ios/ios-objc-fundamentals-unit/xcode_error_icon.png" style="width: 200px;">
...
<img src="https://curriculum-content.s3.amazonaws.com/ios/ios-objc-fundamentals-unit/xcode_warning_icon.png" style="width: 24px;"> A **warning** is a minor issue that something unexpected might be caused by the code, but won't necessarily cause a crash at run time. Warnings will not impede the scheme being built.

<img src="https://curriculum-content.s3.amazonaws.com/ios/ios-objc-fundamentals-unit/xcode_error_icon.png" style="width: 24px;"> An **error** is a major issue that will almost certainly cause a crash at run time, so the error impedes the scheme from being built.
